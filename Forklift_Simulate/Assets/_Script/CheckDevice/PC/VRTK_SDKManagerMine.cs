...
namespace VRTK
{
    ...
    /// <summary>
    /// The SDK Manager script provides configuration of supported SDKs and manages a list of VRTK_SDKSetupMines to use.
    /// </summary>
    public sealed class VRTK_SDKManagerMine : MonoBehaviour
    {
        /// <summary>
        ...
        {
            public readonly VRTK_SDKSetupMine previousSetup;
            public readonly VRTK_SDKSetupMine currentSetup;
            public readonly string errorMessage;

            public LoadedSetupChangeEventArgs(VRTK_SDKSetupMine previousSetup, VRTK_SDKSetupMine currentSetup, string errorMessage)
            {
        ...
        public delegate void LoadedSetupChangeEventHandler(VRTK_SDKManagerMine sender, LoadedSetupChangeEventArgs e);
        ...
        /// </summary>
        public static VRTK_SDKManagerMine instance
        {
            get
            {
                if (_instance == null)
                {
                    VRTK_SDKManagerMine sdkManager = VRTK_SharedMethods.FindEvenInactiveComponent<VRTK_SDKManagerMine>(true);
                    if (sdkManager != null)
                    {
        ...
        /// </summary>
        /// <returns>Returns `true` if the SDK Manager instance was valid.</returns>
        public static VRTK_SDKSetupMine GetLoadedSDKSetup()
        {
            if (ValidInstance())
            {
        ...
        public static VRTK_SDKSetupMine[] GetAllSDKSetups()
        {
            if (ValidInstance())
            {
                return instance.setups;
            }
            return new VRTK_SDKSetupMine[0];
        }

        /// <summary>
        /// The AttemptTryLoadSDKSetup method attempts to load a valid VRTK_SDKSetupMine from a list if the SDK Manager instance is valid.
        /// </summary>
        /// <param name="startIndex">The index of the VRTK_SDKSetupMine to start the loading with.</param>
        ...
        /// <param name="sdkSetups">The list to try to load a VRTK_SDKSetupMine from.</param>
        /// <returns>Returns `true` if the SDK Manager instance was valid.</returns>
        public static bool AttemptTryLoadSDKSetup(int startIndex, bool tryToReinitialize, params VRTK_SDKSetupMine[] sdkSetups)
        {
            if (ValidInstance())
            {
        ...
        /// <summary>
        /// The AttemptUnloadSDKSetup method tries to load a valid VRTK_SDKSetupMine from setups if the SDK Manager instance is valid.
        /// </summary>
        ...
        /// <summary>
        /// The AttemptUnloadSDKSetup method attempts to unload the currently loaded VRTK_SDKSetupMine, if there is one and if the SDK Manager instance is valid.
        /// </summary>
        ...
        private static VRTK_SDKManagerMine _instance;
        ...
        public VRTK_SDKSetupMine[] setups = new VRTK_SDKSetupMine[0];
#if UNITY_EDITOR
        ...
        [Obsolete("`VRTK_SDKManagerMine.persistOnLoad` has been deprecated and will be removed in a future version of VRTK. See https://github.com/thestonefox/VRTK/issues/1316 for details.")]
        [ObsoleteInspector]
        ...
        /// </summary>
        public VRTK_SDKSetupMine loadedSetup
        {
            get
            {
        ...
        private VRTK_SDKSetupMine _loadedSetup;
        ...
        /// <summary>
        /// The TryLoadSDKSetupFromList method tries to load a valid VRTK_SDKSetupMine from setups.
        /// </summary>
        /// <param name="tryUseLastLoadedSetup">Attempt to use the last loaded setup if it's available.</param>
        ...
        /// <summary>
        /// The TryLoadSDKSetup method tries to load a valid VRTK_SDKSetupMine from a list.
        /// </summary>
        /// <remarks>
        /// The first loadable VRTK_SDKSetupMine in the list will be loaded. Will fall back to disable VR if none of the provided Setups is useable.
        /// </remarks>
        /// <param name="startIndex">The index of the VRTK_SDKSetupMine to start the loading with.</param>
        /// <param name="tryToReinitialize">Whether or not to retry initializing and using the currently set but unusable VR Device.</param>
        /// <param name="sdkSetups">The list to try to load a VRTK_SDKSetupMine from.</param>
        public void TryLoadSDKSetup(int startIndex, bool tryToReinitialize, params VRTK_SDKSetupMine[] sdkSetups)
        {
            ...
            foreach (VRTK_SDKSetupMine invalidSetup in sdkSetups.Where(setup => !setup.isValid))
            {
            ...
            Debug.Log("=o=o=sdddddddddddddddddddddddddddddddddd" + sdkSetups[0].name);

            VRTK_SDKSetupMine previousLoadedSetup = loadedSetup;
            ...
            if (!isDeviceAlreadyLoaded)
            {
                ...
                VRTK_SDKSetupMine[] missingVRDeviceSetups = sdkSetups
                    .Where(setup => setup.usedVRDeviceNames.Except(XRSettings.supportedDevices.Concat(new[] { "None" })).Any())
                    .ToArray();
                foreach (VRTK_SDKSetupMine missingVRDeviceSetup in missingVRDeviceSetups)
                {
...
#if UNITY_EDITOR
        /// <summary>
        /// The SetLoadedSDKSetupToPopulateObjectReferences method sets a given VRTK_SDKSetupMine as the loaded SDK Setup to be able to use it when populating object references in the SDK Setup.
        /// </summary>
        /// <remarks>
        ...
        public void SetLoadedSDKSetupToPopulateObjectReferences(VRTK_SDKSetupMine setup)
        {
        ...
        /// <summary>
        /// The UnloadSDKSetup method unloads the currently loaded VRTK_SDKSetupMine, if there is one.
        /// </summary>
        /// <param name="disableVR">Whether to disable VR altogether after unloading the SDK Setup.</param>
...
#pragma warning restore 618
        ...
        private IEnumerator FinishSDKSetupLoading(VRTK_SDKSetupMine[] sdkSetups, VRTK_SDKSetupMine previousLoadedSetup)
        {
            yield return null;
        ...
        private void ToggleBehaviours(bool state)
        {
            ...
            for (int index = 0; index < listCopy.Count; index++)
            {
                ...
                if (behaviour == null)
                {
                    VRTK_Logger.Error(string.Format("A behaviour to toggle has been destroyed. Have you forgot the corresponding call `VRTK_SDKManagerMine.instance.RemoveBehaviourToToggleOnLoadedSetupChange(this)` in the `OnDestroy` method of `{0}`?", behaviour.GetType()));
        ...
        private static void PopulateAvailableScriptingDefineSymbolPredicateInfos()
        {
            ...
            foreach (Type type in VRTK_SharedMethods.GetTypesOfType(typeof(VRTK_SDKManagerMine)))
            {
