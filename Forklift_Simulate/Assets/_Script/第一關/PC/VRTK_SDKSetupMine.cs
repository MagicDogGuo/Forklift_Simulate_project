...
namespace VRTK
{
    ...
    /// </summary>
    public sealed class VRTK_SDKSetupMine : MonoBehaviour
    {
        public delegate void LoadEventHandler(VRTK_SDKManagerMine sender, VRTK_SDKSetupMine setup);
...
#if UNITY_EDITOR
            if (!EditorApplication.isPlaying && VRTK_SDKManagerMine.ValidInstance())
            {
                VRTK_SDKManagerMine.instance.SetLoadedSDKSetupToPopulateObjectReferences(this);
            }
#endif
        ...
        public void OnLoaded(VRTK_SDKManagerMine sender)
        {
        ...
        public void OnUnloaded(VRTK_SDKManagerMine sender)
        {
            List<SDK_Base> sdkBases = new SDK_Base[] { systemSDK, boundariesSDK, headsetSDK, controllerSDK }.ToList();
