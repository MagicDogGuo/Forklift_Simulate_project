...
public class FirstPersonController : MonoBehaviour
{
    ...
    //public Sprite crosshairImageChange;
    //public Text crosshairImageText;
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        //    EditorGUILayout.BeginHorizontal();
        //    EditorGUILayout.PrefixLabel(new GUIContent("Crosshair ImageChange", "Sprite to use as the crosshair."));
        //    fpc.crosshairImageChange = (Sprite)EditorGUILayout.ObjectField(fpc.crosshairImageChange, typeof(Sprite), false);
        //    EditorGUILayout.EndHorizontal();

        //    EditorGUILayout.BeginHorizontal();
        //    EditorGUILayout.PrefixLabel(new GUIContent("Crosshair Text", "Sprite to use as the crosshair."));
        //    fpc.crosshairImageText = (Text)EditorGUILayout.ObjectField(fpc.crosshairImageText, typeof(Sprite), false);
        //    EditorGUILayout.EndHorizontal();
